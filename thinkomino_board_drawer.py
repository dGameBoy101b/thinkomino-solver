...
def draw_board(board: ThinkominoBoard, turtle: RawTurtle, radius: float, red = 'red', orange = 'orange', yellow = 'yellow', green = 'green', blue = 'blue', purple = 'purple'):
	...
	for tile in board:
		...
		draw_tile(tile, turtle, radius, red, orange, yellow, green, blue, purple)
		turtle.penup()
